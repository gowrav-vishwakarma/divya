...
class Frontend extends ApiFrontend {
    function init(){
        ...
        // $auth->setModel('Distributor','username','password');
//            ->allow('demo','demo')
        ...
        $this->add('Menu',null,'Menu')
            ...
            ->addMenuItem('register','New Registration')
            // ->addMenuItem('downlineview','Downline View')
            ->addMenuItem('treeview','Tree View')
            ->addMenuItem('closings','Closing/Payouts')
            ->addMenuItem('pinmanagement','Pins Managment')
            ->addMenuItem('profile','Profile')
            ->addMenuItem('pagemanagement','Manage Your Pages')
            ->addMenuItem('logout')
            ;
